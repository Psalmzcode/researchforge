export const TEAM = [
  ...
  {
    mono: 'C.N.',
    role: 'Head of Field Data',
    name: '****',
    bio: 'Designs and runs field surveys, digital data collection and household profiling.',
    image: '/team/female-1.png',
    imageAlt: 'Silhouette of Head of Field Data',
  },
  {
    mono: 'B.E.',
    role: 'Data & GIS Lead',
    name: '****',
    bio: 'Builds the spatial and resource-mapping layer behind every ResearchForge study.',
    image: '/team/male-3.png',
    imageAlt: 'Silhouette of Data and GIS Lead',
  },
] as const
